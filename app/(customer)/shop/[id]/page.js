...
export default async function ProductDetailPage({ params }) {
  ...
  return (
    <div className="min-h-screen w-full pt-20 pb-24 bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
        {/* Breadcrumb Bar */}
        <div className="flex items-center gap-2 text-xs font-mono tracking-wider uppercase text-neutral-400 pb-8 border-b border-black/10 dark:border-white/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 pt-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            <div className="relative aspect-3/4 w-full overflow-hidden bg-neutral-100 dark:bg-neutral-900 border border-black/10 dark:border-white/10 rounded-none">
              <Image
                src={product.image}
                alt={product.name}
                fill
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 sticky top-24">
            ...
            {/* Product Title */}
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-macsans font-bold tracking-wide text-neutral-900 dark:text-white leading-tight">
              {product.name}
            </h1>

            {/* Price */}
            <div className="text-2xl font-mono font-semibold text-neutral-900 dark:text-white">
              {product.price}
            </div>

            {/* Description */}
            <p className="text-sm font-proda text-neutral-600 dark:text-neutral-300 leading-relaxed pt-2">
              {product.description}
            </p>
              ...
              <div className="flex items-center gap-3 pt-1">
                {product.colors.map((color, idx) => (
                  <div key={idx} className="flex items-center gap-2">
                    <span
                      className="w-4 h-4 rounded-none border border-black/20 dark:border-white/20 inline-block shrink-0"
        ...
        {/* Customer Reviews & Community Social Proof */}
